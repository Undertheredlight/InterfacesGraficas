...
public class Ventana {
    ...
    public Ventana() {      //contructor vacío para la ventana JFrame
        ...
        frame.setSize(500, 500);     //elige el tamaño de la panlla en px
        ...
        frame.setLocation(600, 300); //Camviar la posición inicial de la pantalla del ordenador
    ...
    public void Panel() { //es void porque no quiero que devuelva nada. Sólo que haga algo. Método para construir un panel
        ...
        //panel.setMinimumSize(new Dimension(200, 100)); //Tam´ño mínimo del panel
    ...
    public void Etiqueta() { //Metodo para construir una etiqueta
        ...
        etiqueta.setBounds(150, 110, 200, 50);     //Para añadir coordenadas (los 2 primeros) y dimensiones (2 ultimos)
